...
public class ErrorHandler {
  ...
  public ErrorDto handleMethodArgumentNotValidException(
    ...
    ArgumentNotValidException e = new ArgumentNotValidException(
      errorFormatService.ErrorFormatExceptionHandle(ex)
    );
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  @ExceptionHandler(NotAuthorizationRessourceException.class)
  public ErrorDto handleNotAuthorizationRessourceException(
    NotAuthorizationRessourceException ex
  ) {
    return new ErrorDto(ex.getMap());
  }
}
