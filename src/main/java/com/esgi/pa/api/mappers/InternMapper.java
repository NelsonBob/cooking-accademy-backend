...
public interface InternMapper {
    ...
    public static List<GetInternResponse> toGetInternResponse(List<Users> entities, List<Intern> interns) {
        return entities.stream()
                .map(entity -> toGetInternResponse(entity, getInternByUser(entity, interns)))
                .distinct()
